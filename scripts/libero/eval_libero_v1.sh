...
# MODEL_DIR=/202431205128/baseline/COPY/MARVEL/checkpoints/libero/rlvr/goal/sft90000rl/ckpt_90000_fm_wacq_gt_ac_goal/global_step_300/actor
# MODEL_DIR=/202431205128/baseline/COPY/MARVEL/checkpoints/libero/rlvr/ckpt_150000/spatial_fm_wacq_seq_9_9.19/global_step_420/actor
...
# DISTURB_INDEX=11      # 指定扰动state维度
# DISTURB_INDEX=32      # Goal Task 7(11,12) 9(31,32)
# DISTURB_INDEX="[3,8,10]"       # 10Task4
# DISTURB_INDEX="[5,8,11]"       
DISTURB_INDEX="[3,10,24,31,38]"     # 10Task5
# DISTURB_INDEX="[5,11,25,32,39]" 

DISTURB_RANGE=0.025              # 指定扰动范围
DISTURB_SEED=0                  # 指定扰动随机种子
DISTURB_SEED_RANGE=5            # 指定扰动随机种子范围
TASK_ID=5                       # 指定任务ID
echo "当前任务是: $LIBERO_TASK_NAME, 任务ID是: $TASK_ID"
...
# mkdir -p /202431205128/baseline/COPY/MARVEL/logs/libero/eval/${CKPT_NAME}/${LIBERO_TASK_NAME}
...
CUDA_VISIBLE_DEVICES=0 python experiments/robot/libero/run_libero_eval.py \
  ...
  --save_plot False \
  --ckpt_name ${CKPT_NAME} \
  --plot_path /202431205128/baseline/COPY/MARVEL/plots/${CKPT_NAME}/${LIBERO_TASK_NAME}_eval_${POST_EXP_NAME}_${DATA_TODAY} \
  ...
  --disturb_seed_range ${DISTURB_SEED_RANGE} \
